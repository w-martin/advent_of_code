        ...
        switch (year) {
            case 2015 -> {
                switch (day) {
                    ...
                    case 11 -> {
                        var solver = new com.will_martin.advent_of_code.year_2015.Day11Solver();
                        switch (part) {
                            case 1 -> System.out.println(solver.solvePart1(data));
                            case 2 -> System.out.println(solver.solvePart2(data));
                        }
                    ...
                    case 12 -> {
                        var solver = new com.will_martin.advent_of_code.year_2015.Day12Solver();
                        switch (part) {
                            case 1 -> System.out.println(solver.solvePart1(data));
                            case 2 -> System.out.println(solver.solvePart2(data));
                        }
                    ...
                    case 13 -> {
                        var solver = new com.will_martin.advent_of_code.year_2015.Day13Solver();
                        switch (part) {
                            case 1 -> System.out.println(solver.solvePart1(data));
                            case 2 -> System.out.println(solver.solvePart2(data));
                        }
                    ...
                    case 14 -> {
                        var solver = new com.will_martin.advent_of_code.year_2015.Day14Solver();
                        switch (part) {
                            case 1 -> System.out.println(solver.solvePart1(data));
                            case 2 -> System.out.println(solver.solvePart2(data));
                        }
                    ...
                    case 15 -> {
                        var solver = new com.will_martin.advent_of_code.year_2015.Day15Solver();
                        switch (part) {
                            case 1 -> System.out.println(solver.solvePart1(data));
                            case 2 -> System.out.println(solver.solvePart2(data));
                        }
                    ...
                    case 16 -> {
                        var solver = new com.will_martin.advent_of_code.year_2015.Day16Solver();
                        switch (part) {
                            case 1 -> System.out.println(solver.solvePart1(data));
                            case 2 -> System.out.println(solver.solvePart2(data));
                        }
                    ...
                    case 18 -> {
                        var solver = new com.will_martin.advent_of_code.year_2015.Day18Solver();
                        switch (part) {
                            case 1 -> System.out.println(solver.solvePart1(data));
                            case 2 -> System.out.println(solver.solvePart2(data));
                        }
                    ...
                    case 19 -> {
                        var solver = new com.will_martin.advent_of_code.year_2015.Day19Solver();
                        switch (part) {
                            case 1 -> System.out.println(solver.solvePart1(data));
                            case 2 -> System.out.println(solver.solvePart2(data));
                        }
                    ...
                    case 20 -> {
                        var solver = new com.will_martin.advent_of_code.year_2015.Day20Solver();
                        switch (part) {
                            case 1 -> System.out.println(solver.solvePart1(data));
                            case 2 -> System.out.println(solver.solvePart2(data));
                        }
                    ...
                    case 21 -> {
                        var solver = new com.will_martin.advent_of_code.year_2015.Day21Solver();
                        switch (part) {
                            case 1 -> System.out.println(solver.solvePart1(data));
                            case 2 -> System.out.println(solver.solvePart2(data));
                        }
            ...
            case 2016 -> {
                switch (day) {
                    case 1 -> {
                        var solver = new com.will_martin.advent_of_code.year_2016.Day01Solver();
                        switch (part) {
                            case 1 -> System.out.println(solver.solvePart1(data));
                            case 2 -> System.out.println(solver.solvePart2(data));
                        }
                    ...
                    case 2 -> {
                        var solver = new com.will_martin.advent_of_code.year_2016.Day02Solver();
                        switch (part) {
                            case 1 -> System.out.println(solver.solvePart1(data));
                            case 2 -> System.out.println(solver.solvePart2(data));
                        }
                    ...
                    case 3 -> {
                        var solver = new com.will_martin.advent_of_code.year_2016.Day03Solver();
                        switch (part) {
                            case 1 -> System.out.println(solver.solvePart1(data));
                            case 2 -> System.out.println(solver.solvePart2(data));
                        }
                    ...
                    case 4 -> {
                        var solver = new com.will_martin.advent_of_code.year_2016.Day04Solver();
                        switch (part) {
                            case 1 -> System.out.println(solver.solvePart1(data));
                            case 2 -> System.out.println(solver.solvePart2(data));
                        }
                    ...
                    case 5 -> {
                        var solver = new com.will_martin.advent_of_code.year_2016.Day05Solver();
                        switch (part) {
                            case 1 -> System.out.println(solver.solvePart1(data));
                            case 2 -> System.out.println(solver.solvePart2(data));
                        }
                    ...
                    case 6 -> {
                        var solver = new com.will_martin.advent_of_code.year_2016.Day06Solver();
                        switch (part) {
                            case 1 -> System.out.println(solver.solvePart1(data));
                            case 2 -> System.out.println(solver.solvePart2(data));
                        }
                    ...
                    case 7 -> {
                        var solver = new com.will_martin.advent_of_code.year_2016.Day07Solver();
                        switch (part) {
                            case 1 -> System.out.println(solver.solvePart1(data));
                            case 2 -> System.out.println(solver.solvePart2(data));
                        }
